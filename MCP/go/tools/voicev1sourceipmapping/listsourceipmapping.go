...
func ListsourceipmappingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/SourceIpMappings%s", cfg.BaseURL, queryString)
...
func CreateListsourceipmappingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_SourceIpMappings",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListsourceipmappingHandler(cfg),
	}
}
